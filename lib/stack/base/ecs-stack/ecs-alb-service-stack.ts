...
export class EcsAlbServiceStack extends base.BaseStack {
  constructor(appContext: AppContext, stackConfig: any) {
    ...
    const ecsCluster = this.loadEcsCluster(
      ecsClusterStackName,
      vpc,
      cloudMapNamespace
    );
    ...
    const infra = new EcsInfraConstrunct(this, "EcsAlbInfraConstrunct", {
      stackName: this.stackName,
      domainName: this.stackConfig.DomainName,
      subDomain: this.stackConfig.SubDomain,
      projectPrefix: this.projectPrefix,
      stackConfig: this.stackConfig,
      appConfig: this.commonProps.appConfig,
    ...
    new EcsCicdConstrunct(this, "EcsAlbCicdConstrunct", {
      ...
      repo: {
        name: this.stackConfig.Repo.Name,
        owner: this.stackConfig.Repo.Owner,
        branch: this.stackConfig.Repo.Branch,
      },
      ecrRepo: repo.ecrRepo,
    });
